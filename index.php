...
print $page->getTopSection();
  ...
  print '<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow">';
    print '<div class="container-fluid mx-5 px-5 py-2">';
      print '<a class="navbar-brand" href="#">Project Name</a>'; //Insert redirect to homepage
      ...
      print '<div class="collapse navbar-collapse" id="navbarSupportedContent">';
        print '<ul class="navbar-nav ms-auto mb-2 mb-lg-0">';
          print '<li class="nav-item px-2">';
            print '<a class="nav-link active" aria-current="page" href="#">Home</a>'; //Insert redirect to homepage
          print '</li>';

          /* If logged in add the My Bookmarks link to navigation  
              <li class="nav-item px-2">
                <a class="nav-link" href="#">My Bookmarks</a> //Insert redirect to bookmarks.php
              </li>
          */

          print '<li class="nav-item px-2">';
            print '<button class="btn btn-outline-light" href="#">Login</button>'; //Insert redirect to form-login.php
          print '</li>';

          /* If logged in change Login button to Logout button : 
              <li class="nav-item px-2">
                <button class="btn btn-outline-light" href="#">Login</button> //Insert redirect to index.php and log user out 
              </li>
          */ 
